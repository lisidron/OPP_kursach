...
# schedule = LessonFetcher.fetch_week_schedule(group_number, year, season)
#
# if schedule:
#     for i, day_schedule in enumerate(schedule):
#         if day_schedule:
#             print(f"Расписание на {['Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота', 'Воскресенье'][i]}:")
#             for day in day_schedule:
#                 print(f"{day.name}:")
#                 for lesson in day.lessons:
#                     print(f"  {lesson.get_start_time()} - {lesson.get_end_time()} | {lesson.get_subject_type()} {lesson.get_name()}")
#         else:
#             print(f"Расписание для дня {['Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота', 'Воскресенье'][i]} не найдено.")
# else:
...
#             print(lesson)
#     else:
#         print(f"Расписание на завтра для группы {group_number} не найдено.")