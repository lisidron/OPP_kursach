...
# url = "https://digital.etu.ru/api/mobile/schedule?groupNumber=3351&weekDay=MON&joinWeeks=false&year=2024&season=autumn"
# days = Day.from_api(url)
#
# if not days:
#     print("Расписание для группы 3351 не найдено.")
# else:
#     for day in days:
#         print(day)
